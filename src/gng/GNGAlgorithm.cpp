...
namespace gmum{
	...
	errorHeap(), dim(dim), m_toggle_uniformgrid(uniformgrid_optimization),
			...
			m_utility_option(utility_option), m_error(0.0), m_utility_k(utility_k)
	{
		DBG(1, "GNGAlgorithm:: Constructing object");
		DBG(10, "GNGAlgorithm::Constructed object with utility "+to_string(utility_option)+" "+to_string(utility_k));
...
//		t1 = boost::posix_time::microsec_clock::local_time();
	    ...
	    if(this->m_utility_option == BasicUtility){
	    	...
	    	DBG(4, "GNGAlgorithm::Adapt::setting utility");
